...
PR_2=0.0# precision recall threshold
...
fore_limit_1 = np.loadtxt('fore_limit_4_1.csv', dtype=np.float, delimiter=',')
...
while query < total_Query_Images:
    ...
    for k in range(len(sequence_score)):
        ...
        print("sscores", sequence_score[np.argsort(sequence_score)[::-1][k]])
