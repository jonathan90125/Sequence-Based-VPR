...
np.savetxt("fore_limit_5_1.csv", fore_limit_1, delimiter=",")
np.savetxt("fore_limit_5.csv", fore_limit, delimiter=",")

fore_limit = np.loadtxt('fore_limit_5.csv', dtype=np.float, delimiter=',')
fore_limit_1 = np.loadtxt('fore_limit_5_1.csv', dtype=np.float, delimiter=',')
