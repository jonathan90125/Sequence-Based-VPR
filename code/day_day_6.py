...
query_directory = './dataset/dataset_3/query/'  # Please modify according to your needs
ref_directory = './dataset/dataset_3/ref/'  # Please modify according to your needs
...
fore_limit = np.loadtxt('fore_limit_3.csv', dtype=np.float, delimiter=',')
