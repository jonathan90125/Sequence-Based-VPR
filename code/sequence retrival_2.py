...
query = 20 # start index for query
            ...
            if seq_best_match[0][seq1] > seq_best_match[1][seq2]:
                ...
                for seq3 in range(len(seq_best_match[2])):
                    ...
                    if seq_best_match[1][seq2] > seq_best_match[2][seq3]:
                        for seq4 in range(len(seq_best_match[2])):
                            if seq_best_match[2][seq3] > seq_best_match[3][seq4]:
                                # print("seg-set index", top_k_idx[seq1],top_k_idx[seq2],top_k_idx[seq3])
                                if seq_top_k[0][seq1] - seq_top_k[1][seq2] <= 3 and seq_top_k[1][seq2] - seq_top_k[2][seq3] <= 3 and seq_top_k[2][seq3] - seq_top_k[3][seq4] <= 3:
                                    # print("seq index 3:", seq_best_match[2][seq3])
                                    loop_id += 1
                                    # print("id",loop_id)
                                    seq_tmp = []
                                    sequence_score.append(seq_best[0][seq1]+seq_best[1][seq2]+seq_best[2][seq3]+seq_best[3][seq4])
