...
#     ref+=1
#
# np.savetxt("fore_limit_4_1.csv", fore_limit_1, delimiter=",")
                                    ...
                                    if seq_best_match[3][seq4] > seq_best_match[4][seq5] and seq_best_match[4][seq5] > fore_limit[seq_best_match[3][seq4]]:
                                        for seq6 in range(len(seq_best_match[5])):
                                            if seq_best_match[4][seq5] > seq_best_match[5][seq6] and seq_best_match[5][seq6] > fore_limit[seq_best_match[4][seq5]]:
                                                ...
                                                # print("id",loop_id)
                                                seq_tmp = []
                                                current_score = seq_best[0][seq1] + seq_best[1][seq2] + seq_best[2][seq3] + seq_best[3][seq4] + seq_best[4][seq5] + seq_best[5][seq6]
                                                ...
                                                # if abs(seq_best_match[1][seq2] - fore_limit_1[seq_best_match[0][seq1]]) < 5 and abs(seq_best_match[2][seq3] - fore_limit_1[seq_best_match[1][seq2]]) < 5 and abs(seq_best_match[3][seq4] - fore_limit_1[seq_best_match[2][seq3]]) < 6 and abs(seq_best_match[4][seq5] - fore_limit_1[seq_best_match[3][seq4]]) < 5:
                                                #     current_score = current_score *1.2
